...
def train_pipeline(start_date: str, end_date: str):
    ...
    latest_block = feature_frame_all[['date', 'gold_inr_10g'] + feature_cols].dropna().copy()
...
def main():
    ...
    with st.sidebar:
        ...
        st.info('The app trains lightweight models on historical market data each run. For deployment, you can pre-save models later.')
    ...
    with tab4:
        ...
        fig3 = px.bar(fi.sort_values('Importance'), x='Importance', y='Feature', orientation='h', height=520)
