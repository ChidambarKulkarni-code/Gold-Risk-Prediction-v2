...
def main():
    ...
    if not run_model:
        st.warning('Click **Run prediction pipeline** to load the latest dashboard.')
        st.stop()
    ...
    tab1, tab2, tab3, tab4 = st.tabs(['Dashboard', 'Model Results', 'Forecast Table', 'Feature Importance'])
